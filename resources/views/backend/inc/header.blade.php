        ...
        <header class="header">
            <div class="page-brand">
                <a class="link" href="#">
                    <span class="brand">
                        <span class="brand-tip"><img src="{{ static_asset('assets/images/logo/logo.png') }}"></span>
                    </span>
                </a>
            </div>
                ...
                <ul class="nav navbar-toolbar">
                            ...
                            <li class="list-group list-group-divider scroller" data-height="240px" data-color="#71808f">
                                <div>
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ static_asset('backend_assets/img/users/u1.jpg') }}">
                                            </div>
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ static_asset('backend_assets/img/users/u2.jpg') }}">
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ static_asset('backend_assets/img/users/u3.jpg') }}">
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ static_asset('backend_assets/img/users/u4.jpg') }}">
                                            </div>
                                            <div class="media-body">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            <img src="{{ static_asset('backend_assets/img/admin-avatar.png') }}">
